...
sqlite3 users.db "DROP TABLE IF EXISTS password_reset;"
...
sqlite3 users.db "CREATE TABLE IF NOT EXISTS password_reset (user_name varchar(63) NOT NULL, token varchar(64) NOT NULL, expires DATETIME NOT NULL, PRIMARY KEY (user_name, token));"